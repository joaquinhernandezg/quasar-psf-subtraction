...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'filter_catalog_hsc_footprint = quasar_psf_subtraction.scripts.filter_catalog_hsc_footprint:main',
            'plot_compare_fitting_method = quasar_psf_subtraction.scripts.plot_compare_fitting_method:main',
        ],
    },
